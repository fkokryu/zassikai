...
FPRとHFSに基づいて、XiaとXuが最初にHFPRを提案しました。しかし、彼らの定義ではHFS h_ijの値が昇順であることを要求します。これにより、DMの元の優先情報が歪め

られ、一貫性の研究におけるHFPRの定義に違反する可能性がある。これらの欠点を克服するために、XuらはHFPRの改訂された定義を提案しました。
